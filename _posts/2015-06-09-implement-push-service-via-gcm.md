...
comments: true
images:
  title: 'http://asset.blog.hibrainapps.net/saltfactory/images/Screen%20Shot%202016-03-23%20at%2012.04.01%20AM.png'
---
...
![Start New Android Studio](http://asset.blog.hibrainapps.net/saltfactory/images/9ceb0e11-523f-44cc-b5df-a34b4d7118e4)
...
![New Project](http://asset.blog.hibrainapps.net/saltfactory/images/07381211-7b35-48c2-8ca1-c6f9396af0a7)
...
![Phone and Table Minimum SDK](http://asset.blog.hibrainapps.net/saltfactory/images/70dd0a1f-a710-414f-b1cb-bf9948c45196)

### Add an activity to Mobile

단순히 GCM을 테스트하기 위해서 우리는 **Blank Activity**를 선택한다. 실제 프로젝트를 새롭게 진행한다면 자신에게 필요한 Activity를 선택하면 된다.

![Add an activity to Mobile](http://asset.blog.hibrainapps.net/saltfactory/images/0375db27-256c-45e9-af2b-c7180c24ce6d)
...
![Customize the Activity](http://asset.blog.hibrainapps.net/saltfactory/images/8300184b-bb71-4b5c-b997-9fabdedf6309)

간단하게 **Gradle** 기반의 Anroid 프로젝트가 만들어졌다.

![created android project](http://asset.blog.hibrainapps.net/saltfactory/images/b45c7903-31b6-481a-8647-9693f55e3f07)

## 앱 등록하기

Android GCM 서비스를 개발하기 전에 GCM을 사용하기 위해 앱을 등록해야한다. Android GCM 사이트에 접속해보자. https://developers.google.com/cloud-messaging/

![](http://asset.blog.hibrainapps.net/saltfactory/images/c5c19610-b2fc-43f1-8168-d73ff8e34d57)
...
![add Cloud Messasing to your exsiting app](http://asset.blog.hibrainapps.net/saltfactory/images/9ab6adf4-f822-4ab0-b7fe-928b17d12706)
...
![Create or Choose an app](http://asset.blog.hibrainapps.net/saltfactory/images/a01fdb5e-1eb5-481b-82c0-0f46898f3a93)
...
![Registration Android App](http://asset.blog.hibrainapps.net/saltfactory/images/a1583124-beeb-4f3a-acfc-093779911535)
...
![Enable google cloud messaging](http://asset.blog.hibrainapps.net/saltfactory/images/67833730-0f41-4f95-bece-0ec13fcc2dd1)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/cde4e93e-795b-48e5-990f-0963cb0f751f)
...
![copy google-services.json](http://asset.blog.hibrainapps.net/saltfactory/images/224e057c-8880-4b53-8aa4-8702c6a36c4d)
...
![Android Studio gradle fresh button](http://asset.blog.hibrainapps.net/saltfactory/images/2e35a3a3-cb7d-4233-aae0-c1530b7df258)
...
![GCM Demo start](http://asset.blog.hibrainapps.net/saltfactory/images/5f8c146a-9cb4-4750-9112-21e2dcc03db1)

![GCM Demo finish](http://asset.blog.hibrainapps.net/saltfactory/images/1fd7d2d1-8bab-4258-90d4-87d73e834e70)
...
![GCM Demo finish](http://asset.blog.hibrainapps.net/saltfactory/images/58c6c243-badf-4b19-951d-e1257af2a789)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/b6e4fd95-f775-4560-acb2-b80ecafae1d8)
...
```
![gcm_provider](http://asset.blog.hibrainapps.net/saltfactory/images/e8b95a14-84d4-4165-8730-b25e811d517c)

이제 Android 디바이스에 GCM으로 메세지가 전송되었는지 Notification Center를 확인하자.

![GCM message](http://asset.blog.hibrainapps.net/saltfactory/images/de43ac19-a66d-4fdf-9b07-5c63777a6b88)
...
```
![HTTP Connection Server](http://asset.blog.hibrainapps.net/saltfactory/images/22a6ef72-9164-4939-90a8-2bdd158e7ec7)
