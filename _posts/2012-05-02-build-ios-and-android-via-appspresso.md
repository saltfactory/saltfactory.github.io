...
![](http://asset.blog.hibrainapps.net/saltfactory/images/aaf7fb22-e0aa-4709-bdf9-bfd4e4a25e6a)

이렇게 project 디렉토리에서 오른쪽 마우스를 선택해서 Run as > Run Appspresso application on Android device를 선택한다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/beefcb0f-22c7-4ac9-bea6-277719d5a491)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/88091137-8a48-47b6-9865-0e32dc3effb5)

![](http://asset.blog.hibrainapps.net/saltfactory/images/e43c967a-78ce-40f5-a17e-27da029e413e)

최초에 Run Configurations를 열어 Appspresso Application을 선택하고 + 가 있는 New launch configuration을 선택한다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/0a7f1832-605f-49c1-aa92-694411030c1c)

그리고 Name에 Run Configrations의 이름을 지정한다. Run 설정을 여러개하여 실행할 수 있는데 이 때 구분할 수 있는 것이 여기에 작성하는 Run Configurations 이름이다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/6cc83e4b-c132-44cc-b7ff-2f0e34367783)

이름을 지정하고 나면 Target 탭을 선택한다. Target Platform에서 iOS를 선택한다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/26ff94ba-2cb9-40c5-a32c-9b76159743b7)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/b254b5b3-3ed4-43ae-bd39-b782beb2935a)

![](http://asset.blog.hibrainapps.net/saltfactory/images/ed6d2331-3859-4535-93d2-3dbe25dd283a)

이렇게 디바이스를 선택하고 code sign을 선택하고 나서 apply를 하고 run을 하던지 아니면 바로 run을 실행한다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/a324e5d3-885c-4416-988b-e8a17a9ebe56)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/aabd8eeb-dc9e-43a0-b70b-bcd244c0d333)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/f85c3e89-30ae-4af1-b07e-3a7d879d34c2)

이렇게 iTunes에 앱을 추가하고 동기화를 진행하면 이제 iPhone 실제 적으로 앱이 추가가 된다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/4b77b93e-4157-4c38-b7e7-79116a60659a)

![](http://asset.blog.hibrainapps.net/saltfactory/images/88f0a1bb-ef98-49cf-8216-fb3986fda295)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/a17f23b3-7325-412f-b93f-52cd240ab689)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/a9f37673-e96e-4c84-8471-3aa87de4a036)

![](http://asset.blog.hibrainapps.net/saltfactory/images/4ca46684-09e3-4da7-ab23-a4c418f684c6)
