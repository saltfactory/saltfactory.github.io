...
comments: true
images:
  title: 'https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/09d82608-45b2-4a40-a28e-0a978dd0ac83'
---
...
![연락처정보](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/0027f201-3fe8-41ee-9fe7-b0a3ae2c8a35)
...
![결제정보](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/58edd0fb-6584-4cbc-8ef0-0bd2d870fddb)

전화 인증을할 때 AWS에서 발생한 **PIN**값을 전화기에 입력하면 된다. 어렵지 않다.
![PIN 정보](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/14dde885-7675-4a82-a5e7-b464bcab8eda)

### 계획지원

우리는 먼저 **기본(무료)**를 사용해볼 것이기 때문에 체크하고 다음으로 넘어간다.

![계획지원](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/209c6a49-f902-4ecf-ad6d-86532768e2de)

![가입완료](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/df95239a-9ac0-4dfc-8a5f-15fd3c3fabbb)
...
![AWS 관리자콘솔](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/35d6a138-f00e-4607-a125-82f46ffe9fdb)

AWS 서비스중에 EC2를 클릭하면 **EC2 Dashboard**로 이동한다.

![EC2 dashboard](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/df5a09f5-42c3-4355-9fc5-c0cf8ce9170e)
...
![Choose AMI](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/93f12a97-6399-4773-b993-76de0bece8db)
...
![Choose an Instance Type](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/e6174334-e994-4862-b65f-1727e5dbd8f2)
...
![Review Instance Launch](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/e6dafd94-fa8f-4469-b6be-1d5281a0f8e8)
...
![create a new key](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/455f2cf8-b5dc-4e5e-840d-23ecbc09a283)
...
![Launch Status](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/09cd4805-c451-412a-880b-4b88e1786d56)

EC2 Dashboard로 돌아가보자.

![EC2 Dashboard](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/5a066576-3b3c-4eea-949d-5915b1b0c22b)

앞에서 인스턴스를 생성하지 않았을 때와 달리 지금은 **1 Running instances**와 **1 Volumes** 그리고 **1 key Pairs**로 표시가 된다. **1 Runnings Instance**를 클릭하자.

![Running Instances](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/c741e258-ff58-4b7a-8461-508f5023b139)
...
![ssh](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/3b4a7bdd-4bc4-409f-b734-36f0ab999e4d)
