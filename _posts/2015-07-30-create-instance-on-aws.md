...
category : aws
tags : [aws, amazon, ubuntu, instance]
comments : true
images :
...
![연락처정보](http://assets.hibrainapps.net/images/rest/data/553?size=full&m=1438233380)
...
![결제정보](http://assets.hibrainapps.net/images/rest/data/554?size=full&m=1438233468)

전화 인증을할 때 AWS에서 발생한 **PIN**값을 전화기에 입력하면 된다. 어렵지 않다.
![PIN 정보](http://assets.hibrainapps.net/images/rest/data/555?size=full&m=1438233888)

### 계획지원

우리는 먼저 **기본(무료)**를 사용해볼 것이기 때문에 체크하고 다음으로 넘어간다.

![계획지원](http://assets.hibrainapps.net/images/rest/data/556?size=full&m=1438234714)

![가입완료](http://assets.hibrainapps.net/images/rest/data/557?size=full&m=1438234756)
...
![AWS 관리자콘솔](http://assets.hibrainapps.net/images/rest/data/558?size=full&m=1438235104)

AWS 서비스중에 EC2를 클릭하면 **EC2 Dashboard**로 이동한다.

![EC2 dashboard](http://assets.hibrainapps.net/images/rest/data/559?size=full&m=1438235190)
...
![Choose AMI](http://assets.hibrainapps.net/images/rest/data/565?size=full&m=1438237581)
...
![Choose an Instance Type](http://assets.hibrainapps.net/images/rest/data/566?size=full&m=1438237621)
...
![Review Instance Launch](http://assets.hibrainapps.net/images/rest/data/567?size=full&m=1438237669)
...
![create a new key](http://assets.hibrainapps.net/images/rest/data/568?size=full&m=1438237810)
...
![Launch Status](http://assets.hibrainapps.net/images/rest/data/569?size=full&m=1438237854)

EC2 Dashboard로 돌아가보자.

![EC2 Dashboard](http://assets.hibrainapps.net/images/rest/data/570?size=full&m=1438304252)

앞에서 인스턴스를 생성하지 않았을 때와 달리 지금은 **1 Running instances**와 **1 Volumes** 그리고 **1 key Pairs**로 표시가 된다. **1 Runnings Instance**를 클릭하자.

![Running Instances](http://assets.hibrainapps.net/images/rest/data/571?size=full&m=1438304748)
...
![ssh](http://assets.hibrainapps.net/images/rest/data/573?size=full&m=1438305583)
