...
![](http://blog.hibrainapps.net/saltfactory/images/dadddb33-a5f1-46a2-a13e-6047295d1c7c)
...
![](http://blog.hibrainapps.net/saltfactory/images/6f6e789b-f0e3-4545-9bc2-4dbc762053e5)

이렇게 카카오계정의 접근을 허용하면 다음은 `KakaoStoryMainActivity`가 열려야하는데 다시 `KakaoStoryLoginActivity`로 돌아가는 것을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/ecbb7ced-3900-495a-ae09-046ad4de5b95)
...
![](http://blog.hibrainapps.net/saltfactory/images/dc019bda-6080-47b3-abcb-6ac5df917526)
...
![](http://blog.hibrainapps.net/saltfactory/images/3f106e0a-7e44-45a4-b454-3aea8a33fa6c)
...
![](http://blog.hibrainapps.net/saltfactory/images/015f628c-fd82-4068-a229-c21eb3edb4cb)

프로필 버튼을 눌러보자. 그러면 현재 내가 사용하고 있는 카카오스토리의 배경화면과 프로필 화면 그리고 프로필 정보를 가져와서 업데이트한 것을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/305fb3a6-ac0a-4acd-a5de-0a101a652024)

다음은 포스팅 버튼을 눌러보자. 미리 지정한 글을 카카오스토리 내에 포스팅한 것을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/a4bb77f4-a9cf-4639-baf4-cbf85c71c345)
...
![](http://blog.hibrainapps.net/saltfactory/images/055f2d08-74c3-4692-bb08-f1fdb18c53b5)
...
![](http://blog.hibrainapps.net/saltfactory/images/a8ad66aa-b145-413c-803c-ff36b9d28021)
...
![](http://blog.hibrainapps.net/saltfactory/images/ecfb785f-0e6b-426a-8384-13173e85b276)
...
![](http://blog.hibrainapps.net/saltfactory/images/fb9b744d-6a7f-4963-a04a-0552f65fa628)
...
![](http://blog.hibrainapps.net/saltfactory/images/beec9b11-7dd8-46f8-b78b-307d76d99072)
...
![](http://blog.hibrainapps.net/saltfactory/images/3e816b0e-43a8-4f3c-b81e-b63a5117bd40)
...
![](http://blog.hibrainapps.net/saltfactory/images/391849b5-50ea-4b6b-8596-874a5916f965)

그러면 카카오계정으로 로그인하려는 앱에서 접근 권한을 허용하는 문구가 나온다. 허용을 선택한다.

![](http://blog.hibrainapps.net/saltfactory/images/eb5f3e9d-f312-4db4-97d4-6251bc746248)

그러면 테스트를 위해 추가한 MyActivity가 실행된다.

![](http://blog.hibrainapps.net/saltfactory/images/e79a5f21-897f-4be9-b2d6-19ad039bb844)

카카오스토리 포스팅 버튼을 눌러보자. 그러면 카카오에 글을 등록하기 이전에 먼저 앨번에서 사진을 선택할 수 있게 사진첩 앨범이 열리는 것을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/afa1f527-a08c-4263-861d-80676f99d14b)

사진을 선택하고 글상자에 글을 입력한다.

![](http://blog.hibrainapps.net/saltfactory/images/607a3ab8-b14f-4688-9161-9609de6e54af)

포스팅 버튼을 클릭해서 실제 포스팅이 완료 되었는지 확인한다.

![](http://blog.hibrainapps.net/saltfactory/images/4135b596-ca43-4b4c-a1f9-e2d27ab31a82)
