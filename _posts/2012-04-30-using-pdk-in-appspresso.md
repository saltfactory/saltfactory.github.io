...
![](http://blog.hibrainapps.net/saltfactory/images/aed13eb0-7a37-46ee-9340-a87f2cee83a2)

새로운 Plugin 프로젝트를 만들때 Project Name을 입력하고 나중에 plugin의 유일한 식별을 하기 위해서 ID를 지정하고 버전 정보를 입력한다.

![](http://blog.hibrainapps.net/saltfactory/images/1718499c-75c0-47d0-80fc-8d721f175d6a)

다음은 iOS 버전의 네이티브 모듈 plugin을 만들 것인지, Android 네이티브 모듈 plugin을 만들 것인지 선택을 한다. 두가지 모두 선택하면 두가지 모듈 프로젝트가 workspace에 추가된다.

![](http://blog.hibrainapps.net/saltfactory/images/dd0b0f7e-78cd-4ed6-a5bd-44b65dc93821)

첫번재로 Android 모듈을 설정하는 화면이다. plugin project에서 새로운 module project를 사용하게 되는데 이때 안드로이드 버전의 모듈 프로젝트를 생성한다.

![](http://blog.hibrainapps.net/saltfactory/images/65c0372b-32cd-48bf-bbae-b29f9e10b5d8)
...
![](http://blog.hibrainapps.net/saltfactory/images/b2bd8e65-cf3a-4c9a-ad49-1ffe579eaad4)

우리는 위에서 Android와 iOS 두가지 모듈 모두를 사용하는 plugin을 만든다고 체크하였기 때문에 이번에는 iOS 모듈을 설정하는 화면이 나타난다.

![](http://blog.hibrainapps.net/saltfactory/images/421dbf5c-cf55-4dea-9403-9ddd9509cf0e)

안드로이드 모듈의 메인클리스와 달리 iOS에서는 네이밍 규칙에 클래스 파일에 .을 사용하기 보다 다음과 같이 사용하기 때문에 다음과 같은 형태로 자동으로 만들어진다.

![](http://blog.hibrainapps.net/saltfactory/images/4f141078-242d-431e-a528-aff4256976c4)
...
![](http://blog.hibrainapps.net/saltfactory/images/129d3a52-8c9d-45ca-bebb-1b774f5a85c1)
...
![](http://blog.hibrainapps.net/saltfactory/images/daf1bd97-6406-4598-923e-b38d4caea79e)
...
![](http://blog.hibrainapps.net/saltfactory/images/5169c6bb-a869-48fd-9a8d-6c2f403aac0e)

![](http://blog.hibrainapps.net/saltfactory/images/8fa8ed99-f58f-4e48-8510-5390008d8121)

![](http://blog.hibrainapps.net/saltfactory/images/d36f698a-7d9c-490c-9dc1-a4197f2d272a)

![](http://blog.hibrainapps.net/saltfactory/images/66247cb8-5016-4a4f-a7e3-24e54b2ff11a)

![](http://blog.hibrainapps.net/saltfactory/images/ef5facff-60f7-42ab-b111-b407b2a468f8)
...
![](http://blog.hibrainapps.net/saltfactory/images/b470dcc8-0237-4d4e-ac2f-a01815348390)
...
![](http://blog.hibrainapps.net/saltfactory/images/7dbb1917-0644-4c89-8f97-9549d60b66a9)
...
![](http://blog.hibrainapps.net/saltfactory/images/9fea7e77-289e-4432-bf22-b2611294ac4e)
...
![](http://blog.hibrainapps.net/saltfactory/images/e5565c53-e02a-43fd-bf26-55480381e6de)
