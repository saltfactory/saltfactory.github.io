...
comments: true
images:
  title: 'http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/5aa58637-424f-4c28-9d19-acd6d0ad0686'
---
...
![git clone docker-yobi](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/f735ca78-957c-4866-9df4-f0bedcb7df11)
...
![build](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/42f3dee5-6196-41db-86da-f3eadaeb0e39)
...
![not found YOBI_HOME](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/62905290-eebc-4a88-a0be-266e1f7b677d)
...
![setting YOBI_HOME](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/84c14270-c1c1-4909-ba6e-e3744d1cec43)
...
![startup docker-yobi](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/695ce50a-4f6e-43eb-9087-7662652f2dcb)

브라우저를 열어서 Yobi가 정상적으로 실행되는지 확인해보자. host에 호스트 IP를 입력하면된다. 이 예제는 boot2docker를 사용하여 만들 것이라 boot2docker의 IP를 입력했다.

http://host:9000
![open yobi](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/3fb22afb-85b4-4db6-8892-8292e040f7fa)
...
![docker ps](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/2ad4ad32-0575-4949-b2e0-cee65b6c34db)
...
![logs.sh](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/56e03610-bb91-4159-b2b7-c64566f92060)
...
sh stop.sh
```
![stop docker-yobi](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/9326798e-b822-4e91-bf04-ba5db6200ed1)
...
docker ps -a
```
![stoped container](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/957a6b4f-73dc-4a59-9153-32c26154a591)
...
![sh rm.sh](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/b88231f9-875c-4f0e-b706-d3e9284576a9)
