...
![phonegap create {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/8167a771-5560-46bf-9e75-8c058e6ecf7c)
...
![phonegap ios platform {max-width: 600px;}](http://blog.hibrainapps.net/saltfactory/images/2774593a-84c1-46b1-bf8f-87aa4c93b3a0)
...
![xcode project {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/d4679763-3330-4cfc-8426-ac893ca50ac1)
...
![xcode build phases {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/b64c2311-cd71-4d3f-8b7a-bc9bb7a6128f)
...
![New file {max-width: 600px;}](http://blog.hibrainapps.net/saltfactory/images/06bda890-7951-4094-bf48-25d05bde7c03)
...
![New file {max-width: 600px;}](http://blog.hibrainapps.net/saltfactory/images/38e1f854-e64b-47df-b5a3-4a7b5d4a2354)

![New file {max-width: 600px;}](http://blog.hibrainapps.net/saltfactory/images/9db90376-fe79-462e-86b5-3dd9eccda788)
...
![cordova header import {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/532462f1-5db4-4eb9-a948-415bd2e512f2)

아래와 같이 `Cordova/CDV.h`를 import하면 위의 에러가 사라진다. `Cordova/CDV.h`를 열어서 확인하면 그 안에 `CDVPlugin.h`를 import하고 있는 것을 확인할 수 있다.

![import header {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/8f958f3b-ec50-40d9-8de1-af277cee7c2f)
...
![ios simulator {max-width:320px;}](http://blog.hibrainapps.net/saltfactory/images/a62b28e7-64f8-4815-9c15-5886852b86c3)
...
![ios simulator {max-width:320px;}](http://blog.hibrainapps.net/saltfactory/images/6a153987-a8db-4a48-8f7b-b81c932bff92)
...
![ios simulator {max-width:320px;}](http://blog.hibrainapps.net/saltfactory/images/ef40f399-3b5d-4de2-b2fb-bb9cf981affa)
...
![plugins list {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/785d44cb-3b98-463f-aedb-942f1a97334b)
...
![add plugin {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/9c10fcdb-810c-4af7-ab82-01b321e5540b)
...
![plugins list {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/12b2a30c-08c5-4490-a2a5-71025af7cad7)
...
![plugins list {max-width:600px;}](http://blog.hibrainapps.net/saltfactory/images/607f860f-a319-491c-ade0-bec8eff01a9c)
...
![ios simulator {max-width:320px;}](http://blog.hibrainapps.net/saltfactory/images/376a555b-fad0-4e5a-a385-9e4a60f0c0d4)
