...
![provisioning profiles](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/ca782683-836f-40ab-9f68-b0ad495148c9)

**+ 버튼**을 클릭하자. 우리는 Ad-Hoc 배포를 위한 provisioning profile을 만들 것이기 때문에 Ad Hoc을 선택하고 Continue를 선택한다.

![distribution ad-hoc](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/f2a06d0e-120d-490d-a3b1-e66ad0967a58)

다음은 provisioning profile에 인증될 앱을 선택하는 화면이 나오는데 해당하는 ***App ID***를 선택한다.

![select app id](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/e84d1d2b-1e88-4da9-9993-7f6ecf8dbbff)
...
![select certificates](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/65e2b2e2-3d0c-4ac0-ab9c-c286bdca4a22)
...
![select device](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/f3f54c72-2fb7-4675-a974-54cdbe03fc8c)

마지막으로 **provisioning profile의 이름**을 입력한다. 우리는 saltfactory_tutorial_ad-hoc 으로 저장하였다.

![name generate](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/9918df37-e4a3-405f-b0c3-e398c0cabd9a)

**generate**를 선택하면 distribution provisioning profile이 만들어 질 것이다.

![generated profile](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/73de4a7c-b3ff-4314-9b55-a237b8320939)

![generated profile lists](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/2dc67877-c39d-4917-bd8b-883a03291cbc)
...
![build scheme](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/832f2a01-24fc-4c3a-8fac-82f2d3cac065)

**Archive 버튼**을 누른다. 만약에 provisioning profile 정보와 code sign의 정보가 일치되지 않을 경우 다음과 같은 에러를 만나게 된다.

![code sign error](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/7358ee3d-ed5c-4e7f-99f6-799ce4e9353f)

provisioning profile과 code sign이 이상없이 인증이 완료되면 다음과 같이 **Organizer 창**이 나타난다.

![organizer window](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/1eef2553-2523-4499-9461-ae8b718a41fb)
...
![distribution method](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/bc8c0a87-38f1-48f2-8dd8-b0ea003e5094)

우리가 앞에서 만든 provisioning profile인 saltfactory_tutorial_ad-hoc을 선택하고 Export를 하도록 한다.

![choose profile sign](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/7cbf9c68-1920-4878-b804-fb4c9b120049)
...
![export files](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/13c17b39-30bc-468f-a657-170f4bbf964d)
...
![create ota directory](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/8ad4c546-8cec-4826-8251-df27441b585d)

맥에 설치했다면 다음과 같이 finder에서 dropbox 디렉토리 안에 ota 디렉토리가 동기화 되어 생성된 것을 확인할 수 있다.

![created ota directory](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/5437aad5-f34b-46b6-9cfe-af8aa61a2531)
...
![copy share link](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/fceb6823-4ae4-42b9-84b7-de4af7a70252)
...
```
![application url](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/4c011264-c3f3-4926-ba68-24f7ebba975f)
...
![files](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/7f6d2e48-1e40-435c-b8f8-78972a25d569)
...
![download.html](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/95d791af-16fb-43b6-b897-5bfd520d3369)
...
![send url to iphone](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/5ce51685-b69a-46f6-8100-06b1b1ebd700)

메세지로 받은 링크를 열어보면 다음과 같이 열린다.

![message income {width:320px;}](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/e7b8aaba-aaab-40b7-9a6f-8faf0dfe363b)
![open mobile safari {width:320px;}](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/3031e2b2-f18a-41f6-97c2-c2ec831aeca4)
![open ota site {width:320px;}](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/f3206cd3-6dd1-4ccc-963f-8438728b1060)

이렇게 설치할 수 있는 download.html 이 열리게 되는데 SFAdHocDemo.ipa를 다운받을 수 있는 링크를 눌러보자. 아래와 같이 다운받을 앱이 나타나고 install을 선택하면 아이폰에 설치가 진행된다.

![push install message {width:320px;}](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/5d076208-61e7-4aca-8449-4c14a83a0c34)
![install app on iphone {width:320px;}](https://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/c3854d17-0eaa-4c47-8665-aed1777b8eba)
