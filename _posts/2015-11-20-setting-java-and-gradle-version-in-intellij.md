...
category : java
tags : [java, spring, springboot, gradle, intellij]
comments : true
images :
  title : http://assets.hibrainapps.net/images/rest/data/822?size=full&m=1448081040
---
...
![](http://assets.hibrainapps.net/images/rest/data/817?size=full&m=1448079230)
...
![](http://assets.hibrainapps.net/images/rest/data/812?size=full&m=1448068523)
...
![](http://assets.hibrainapps.net/images/rest/data/813?size=full&m=1448068592)
...
![](http://assets.hibrainapps.net/images/rest/data/814?size=full&m=1448068838)
...
![](http://assets.hibrainapps.net/images/rest/data/815?size=full&m=1448069099)
...
![](http://assets.hibrainapps.net/images/rest/data/816?size=full&m=1448078863)
...
![Build, Execution, Deployment](http://assets.hibrainapps.net/images/rest/data/818?size=full&m=1448079557)
...
![change Gradle JVM](http://assets.hibrainapps.net/images/rest/data/819?size=full&m=1448080414)

다시 Gradle을 빌드해보자. 이제 프로젝트의 Gradle과 IntelliJ의 Java와 Gradle 설정이 맞아서 문제 없이 빌드가 성공되는 것을 확인할 수 있다.

![](http://assets.hibrainapps.net/images/rest/data/821?size=full&m=1448080516)
