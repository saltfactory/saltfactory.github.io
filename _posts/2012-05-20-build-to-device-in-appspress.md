...
![](http://blog.hibrainapps.net/saltfactory/images/b1596dd2-c89d-4c27-a7a6-09189d3c256c)

이렇게 project 디렉토리에서 오른쪽 마우스를 선택해서 Run as > Run Appspresso application on Android device를 선택한다.

![](http://blog.hibrainapps.net/saltfactory/images/72a39251-6111-4554-a7c7-e94c003fb72f)
...
![](http://blog.hibrainapps.net/saltfactory/images/879b0e62-61c0-4839-a8db-7437bf3f2994)

![](http://blog.hibrainapps.net/saltfactory/images/73b067cd-aa50-4021-976a-93ccffd5102f)

최초에 Run Configurations를 열어 Appspresso Application을 선택하고 + 가 있는 New launch configuration을 선택한다.

![](http://blog.hibrainapps.net/saltfactory/images/c944af3a-2f92-4d08-aa16-553b26b78d35)

그리고 Name에 Run Configrations의 이름을 지정한다. Run 설정을 여러개하여 실행할 수 있는데 이 때 구분할 수 있는 것이 여기에 작성하는 Run Configurations 이름이다.

![](http://blog.hibrainapps.net/saltfactory/images/2bc6f235-87f8-43ec-89c0-5f35e6134b38)

이름을 지정하고 나면 Target 탭을 선택한다. Target Platform에서 iOS를 선택한다.

![](http://blog.hibrainapps.net/saltfactory/images/3c62ddd7-30f0-4c6d-9850-a88bc339015c)
...
![](http://blog.hibrainapps.net/saltfactory/images/6827c734-da86-4f21-9f88-c67def06870f)

![](http://blog.hibrainapps.net/saltfactory/images/0515bfae-dd4d-4b59-b0b3-c217790b0a07)

이렇게 디바이스를 선택하고 code sign을 선택하고 나서 apply를 하고 run을 하던지 아니면 바로 run을 실행한다.

![](http://blog.hibrainapps.net/saltfactory/images/bc3b4ede-9915-455c-afc4-9d500c7bc0c1)
...
![](http://blog.hibrainapps.net/saltfactory/images/affe57dd-419c-49e3-8f5e-d207afe60724)

![](http://blog.hibrainapps.net/saltfactory/images/3918f79c-9678-422c-a1a6-cb714c383ec5)
...
![](http://blog.hibrainapps.net/saltfactory/images/23041754-46e7-4461-ab75-167888ec5405)

이렇게 iTunes에 앱을 추가하고 동기화를 진행하면 이제 iPhone 실제 적으로 앱이 추가가 된다.

![](http://blog.hibrainapps.net/saltfactory/images/65bf965d-0f9b-4ecc-8a38-5acbcb0ede69)

![](http://blog.hibrainapps.net/saltfactory/images/a715f134-5e87-40a7-913d-450e4d14340f)
...
![](http://blog.hibrainapps.net/saltfactory/images/d5948594-07ee-4ebf-8410-30e338c6b10a)
...
![](http://blog.hibrainapps.net/saltfactory/images/ba0c1bd9-6963-4f71-98cf-499651e231ad)

![](http://blog.hibrainapps.net/saltfactory/images/85b78a74-aa0b-4659-8172-0de15e5cdce4)
