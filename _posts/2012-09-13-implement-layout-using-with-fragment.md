...
![](http://blog.hibrainapps.net/saltfactory/images/070137db-ea73-4e33-8f22-a1e34944e37c)
...
![](http://blog.hibrainapps.net/saltfactory/images/fafedb5a-83ee-4507-8150-173727fcf508)
...
![](http://blog.hibrainapps.net/saltfactory/images/ca3ffb0e-2bf3-4cf3-b0df-36ea531decbd)

그리고 Activity를 만드는 화면에서 MasterDetailFlow를 선택한다. 그리고 Debug Configurations에 x86 AVD를 이용해서 빌드될 수 있게 한다.

![](http://blog.hibrainapps.net/saltfactory/images/91bc7ed9-5990-427c-b260-88a4a72cbefe)

에뮬레이터로 빌드해서 실행하게 되면 간단한 item의 목록이 나타나고 item을 선택하면 디테일화면으로 전환되는 예제이다.

![](http://blog.hibrainapps.net/saltfactory/images/9c1ae1cc-deae-439f-8238-35edb2d8e1c2)

디폴트로 생성된 클래스를 살펴보면 Fragment 클래스를 상속받아서 만든  ItemListFragment.java와 ItemDetailFragment.java가 생성된 것을 볼 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/0cbf502c-1e64-4b3e-98b0-edc2d95cd7ff)
...
![](http://blog.hibrainapps.net/saltfactory/images/260db4bf-143b-412c-a737-db3317d1a492)

이렇게 로그의 필터를 추가하면 다음과 같이 설정이 된다.

![](http://blog.hibrainapps.net/saltfactory/images/f341943b-63a2-4f6a-a579-b3e06fb38680)

이제 빌드하고 실행해서 로그를 확인해보자.

![](http://blog.hibrainapps.net/saltfactory/images/6c701e6e-604b-40b7-a210-d0cb93b2efd6)
...
![](http://blog.hibrainapps.net/saltfactory/images/4206368f-fb8f-4036-bff0-257448b2c6d1)
...
![](http://blog.hibrainapps.net/saltfactory/images/943ecede-57e0-447b-b41d-c71f26cdc86b)
