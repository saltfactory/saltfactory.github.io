...
comments: true
images:
  title: 'http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/61576155-cbff-4de8-a7b5-243bb2e3d409'
---
...
![샘플 데이터 구조](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/c0febede-87fd-4742-9a64-b0f554a11dd8)
...
![scp 복사 ](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/48b56012-cf62-4fda-9001-20174634f2cc)

**CASE 백업서버:**

**scp**로 복사가 완료되면 **"백업서버"**에서 **"메인서버"**로 부터 파일이 복사가 되었는지 확인해보자.

![backup 파일확인](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/9b3a9df0-064b-4842-ad8f-00b18b988ccc)
...
![ssh-keygen](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/646a9017-a46a-43b9-8149-c0b185e3ee72)
...
![id_rsa.pub](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/2e50b73c-36b4-4ecc-92f4-43ce558ca546)
...
```
![copy backupserver id_rsa.pub](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/8c493c70-d977-4cfe-83b2-5454bc6cdb26)
...
![id_rsa.pub 추가](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/b68b9964-3eda-4275-b1b7-0f4950be07af)
...
![비밀번호 없이 ssh 로그인](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/2830dee6-febe-44d7-bb2e-65cfd4e13067)
...
![duplicity 백업](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/c5bd6fa5-e337-4fb2-90ff-07d4ed4ce3d5)

백업된 결과를 보면 **SouceFiles** 1개가 있고 에러 없이 백업이 완료되었다는 메세지를 받는다. 이렇게 백업을 하게 되면 백업으로 지정한 디렉토리 이하의 파일과 디렉토리들이 백업서버에 저장이 된다.

![백업 대상 내 백업](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/6440598c-8a7a-4eb3-9347-5f6d93d77370)
...
```
![백업대상 백업](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/a4a90aa5-daf6-42bb-b14a-6aaff8411b25)
...
![백업파일 ](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/9230f814-cf18-4436-b876-7d654d76ad7e)
...
![백업대상 백업](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/4d33a3cc-e839-4b3e-a132-a0b1924582e3)
...
```
![디렉토리 복원](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/6fe43061-e4d3-4c83-b976-0a6598e59c4f)
...
```
![파일 복원](http://hbn-blog-assets.s3.ap-northeast-2.amazonaws.com/saltfactory/images/7a1bd27f-e756-468f-a136-27ef9f02fd5f)
