...
![](http://blog.hibrainapps.net/saltfactory/images/5743dc13-4afc-4580-925f-4b985ef430ff)
...
![](http://blog.hibrainapps.net/saltfactory/images/b06f8ae7-56e0-4dde-b6ea-c4d5993b6ea5)
...
![](http://blog.hibrainapps.net/saltfactory/images/ba54e47c-8d3f-4f1f-a7f6-b527fd550b29)

## Android 설정

Android 앱 개발을 위해서 Android SDK 디렉토리를 아래와 같이 지정한다.

![](http://blog.hibrainapps.net/saltfactory/images/2260af74-729a-4772-a9b0-5ed4ff4e4955)

이제 Project를 만들어서 두가지 다른 디바이스에서 동작하는 간단한 앱을 만들어 보자.

새로운 Project를 생성해야하는데 "Appspresso Application Project"로 프로젝트를 하나 생성한다.

![](http://blog.hibrainapps.net/saltfactory/images/87659737-bd6f-484d-b227-942ca524080b)

프로젝트 이름은 SaltfactoryHybridTutorial 이라고 앱의 정보를 입력한다.

![](http://blog.hibrainapps.net/saltfactory/images/5e188da9-1ba0-483e-87f6-c6a563cc5b7b)

Finish를 눌러 마쳐도 되고 Next를 눌러서 Appspresso에서 기본적으로 제공해주는 UI framework를 선택할 수도 있다.

![](http://blog.hibrainapps.net/saltfactory/images/a11390f8-d7a9-48d2-9f9e-4f2a9ab9efa3)

Hello World 템플릿을 선택하고 Finish를 하면 Appsresso에서 자동으로 Hello World를 출력해주는 코드를 생성해준다.

![](http://blog.hibrainapps.net/saltfactory/images/fa1ac408-c4a3-4ac2-87e0-bd3f184dfb18)
...
![](http://blog.hibrainapps.net/saltfactory/images/29433645-223b-4219-b082-58eb221b4a7c)

먼저 Run Appspresso application on iOS device를 선택하여 iPhone simulator에 설치하고 실행한다.

![](http://blog.hibrainapps.net/saltfactory/images/bccd4607-a9b1-4546-af5c-2fb5a66bf4a4)
...
![](http://blog.hibrainapps.net/saltfactory/images/6c9165e9-7ec9-44e8-b811-c279a0f9791f)

![](http://blog.hibrainapps.net/saltfactory/images/e4cbd39f-8ac1-43e5-b147-b1068eaab5d4)
...
![](http://blog.hibrainapps.net/saltfactory/images/4cf0d318-09e4-4c7a-9e2e-c9fee1e3591c)

이 메세지를 보게 되면 android sdk를 찾지 못해서 발생한 문제이기 때문에 앞에서 sdk를 설정하는 과정을 해주고 다시 Run을 하면 된다.

![](http://blog.hibrainapps.net/saltfactory/images/f2ca7df8-78e7-47b8-a7de-8f5094c499a3)
...
![](http://blog.hibrainapps.net/saltfactory/images/e35b15dd-2a71-4f5f-88d8-55b167412fcb)

![](http://blog.hibrainapps.net/saltfactory/images/e53f71d8-94df-4513-8427-19bb5c7099c2)
