...
![](http://blog.hibrainapps.net/saltfactory/images/921e9a86-1f39-4f9b-a8a0-88d509b64dd9)
...
![](http://blog.hibrainapps.net/saltfactory/images/426fe750-c0f2-4be0-a639-a7450e67256d)

```
node -v
```

![](http://blog.hibrainapps.net/saltfactory/images/7fb5911c-0fe5-4e0d-bb44-831a2cc72d89)

![](http://blog.hibrainapps.net/saltfactory/images/26f93107-88f5-47ee-8ee3-1aaa9e685c18)
...
![](http://blog.hibrainapps.net/saltfactory/images/d754e0cc-0a8f-4dbb-b92e-979ad109a70f)
...
![](http://blog.hibrainapps.net/saltfactory/images/999d14a0-a6ae-4a2b-9eb3-671c68254727)
...
![](http://blog.hibrainapps.net/saltfactory/images/ac74fe14-2ada-4887-adcb-82f4e4d2eb0f)
...
![](http://blog.hibrainapps.net/saltfactory/images/42620314-87c0-4282-8cd9-6b253c358f17)

만약 ios-sim과 ios-deploy 패키지를 설치하지 않은 상태에서 ionic 프로젝트를 생성하면 다음과 같은 warning을 보게 될 것이다.

![](http://blog.hibrainapps.net/saltfactory/images/72800990-4eef-486d-a72b-b0ab1ccac9a4)
...
![](http://blog.hibrainapps.net/saltfactory/images/b9aed591-983f-4cf9-b16f-2a2ca495f924)
...
![](http://blog.hibrainapps.net/saltfactory/images/5fc2b345-9dda-4286-bd7d-bcde2e389e48)
...
![](http://blog.hibrainapps.net/saltfactory/images/236d5ceb-4521-481a-b4e5-6f9691a24d69)
...
ionic serve
```
![](http://blog.hibrainapps.net/saltfactory/images/549c6ce3-9c07-4ead-8333-bdc6adfb7406)

서버가 실행되면 브라우저에서 프로젝트 확인이 가능하다.

http://localhost:8100

![](http://blog.hibrainapps.net/saltfactory/images/7f572899-bc10-4a80-89ac-a2d3b4f3922f)
...
![](http://blog.hibrainapps.net/saltfactory/images/30cddb2c-5f97-47fd-b591-236b6c243f11)
...
![](http://blog.hibrainapps.net/saltfactory/images/4a6afcc2-ddef-4a84-a1c7-e62615f70437)

기본적으로 target을 지정하지 않으면 Xcode의 기본 시뮬레이터로 앱을 런칭시키는 것을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/9eddf515-140a-42cb-a158-b916dc41e573)
...
![](http://blog.hibrainapps.net/saltfactory/images/67908699-4af9-4efe-bef8-4b1f4e7c5134)
...
![](http://blog.hibrainapps.net/saltfactory/images/49252c9e-6606-49fd-b660-a45549208b96)
...
![](http://blog.hibrainapps.net/saltfactory/images/1285d33b-97ba-4456-bb87-294e7e7e3b00)
...
![](http://blog.hibrainapps.net/saltfactory/images/17e1792f-afdd-4bf6-9027-1ce3c1408201)

위 명령어를 실행하면 Android 앱 파일인 **.apk** 파일이 자동으로 생성이 된다. 이 파일을 위에서 추가한 Andorid SDK를 사용하여 emulator를 실행하여 런칭하게 된다.

![](http://blog.hibrainapps.net/saltfactory/images/382804db-38fb-4dac-8865-9a81651b7bb0)
...
![](http://blog.hibrainapps.net/saltfactory/images/4422df34-644a-4863-ad57-8f1af36b3afb)
...
![](http://blog.hibrainapps.net/saltfactory/images/d2e940c3-7e92-4073-897e-5d668237197a)
...
ionic serve
```
![](http://blog.hibrainapps.net/saltfactory/images/4e16150c-40d5-4e8e-a369-04e0c7ecc740)

http://localhost:8100

서버가 실행되면 브라우저에서 앱을 확인할 수 있다.

![](http://blog.hibrainapps.net/saltfactory/images/1496b01f-c6d3-4fe0-9eee-dab9912e2fde)

책에서 나오는 OAuth2를 사용한 Instragram 로그인도 가능하다.

![](http://blog.hibrainapps.net/saltfactory/images/5f18095c-4bb6-425c-ba9f-fdc78fe1b4fd)

Trendicity는 HTML5 위치정보를 사용하여 주위에 있는 Instagram을 가져오는 앱인데 이 기능역서 Google Map과 연동하여 HTML5로 구현하였기 때문에 브라우저에서 확인이 가능하다.

![](http://blog.hibrainapps.net/saltfactory/images/db6e742f-0846-4307-b050-df62f7de253e)
...
![](http://blog.hibrainapps.net/saltfactory/images/4ea8e2ed-d2ca-44dc-a0b5-4a785a9bd484)
...
![](http://blog.hibrainapps.net/saltfactory/images/2c57d41f-975c-4e3e-88a8-6c640143a044)
...
![](http://blog.hibrainapps.net/saltfactory/images/65f101c5-8435-44cd-967e-056805c25464)
