...
comments: true
images:
  title: 'http://asset.blog.hibrainapps.net/saltfactory/images/7b052ffe-3eeb-4172-ade0-4a67cd263de0'
---
...
![Adobe Edge Inspect 다운로드](http://asset.blog.hibrainapps.net/saltfactory/images/a4df3894-9c17-4f57-86cf-b01693d4aa01)
...
![Adobe Creative Cloud 애플리케이션 설치화면](http://asset.blog.hibrainapps.net/saltfactory/images/edff5d90-bdc4-48fb-b419-604bc30dbd40)

**Adobe Creative Cloud** 설치를 완료하면 메뉴바에서 **Adobe Creative Cloud**아이콘이 생긴다. 이것을 클릭하면 Adobe Account 계정으로 로그인을 할 수 있다.

![Adobe Creative Cloud 로그인](http://asset.blog.hibrainapps.net/saltfactory/images/e8186c0c-2d01-4129-9a80-766b37a856fd)

로그인 후 **Adobe Edge Inspect**가 다운로드가 된다.

![Adobe Edge Inspect 다운로드](http://asset.blog.hibrainapps.net/saltfactory/images/f7a2d541-3062-4536-aaa3-f753e0e3e561)
...
![menu bar](http://asset.blog.hibrainapps.net/saltfactory/images/04de388d-de61-4d2f-9592-6ba744259bea)
...
![chrome browser Extension 설치](http://asset.blog.hibrainapps.net/saltfactory/images/122f564a-a7ff-4604-bb88-67d2b4232f81)

설치 후 Chrome Browser Extension 도구 모음에 Adobe Edge Inspect 아이콘이 표시된다.

![Chrome browser extension 아이콘](http://asset.blog.hibrainapps.net/saltfactory/images/098b7d41-a4da-4c4f-a012-191826db0d39)

아이콘을 클릭할 때 만약 **Adobe Edge Inspect**를 실행하지 않고 **Chrome Extension**을 실행하게 되면 다음과 같은 경고창이 나타난다.

![Inspect 경고창](http://asset.blog.hibrainapps.net/saltfactory/images/4fdac3f4-8f3f-4ba7-a205-daf47b0c9731)
...
![Chrome extension 실행](http://asset.blog.hibrainapps.net/saltfactory/images/9b5a9eb7-87ab-4d87-826e-83210becfe52)
...
![데스크탑 목록](http://asset.blog.hibrainapps.net/saltfactory/images/69bd93e2-fca2-400a-a0d5-95e829dbbd5d)
...
![chrome extension passcode](http://asset.blog.hibrainapps.net/saltfactory/images/cc64c306-6aaa-451a-9a90-708266d36a3e)

모바일 디바이스에서는 다음 그림과 같이 Passcode가 나타난다.

![passcode](http://asset.blog.hibrainapps.net/saltfactory/images/0ef7211a-81dc-4215-bc56-defd52b28ac5)
...
![adobe edge inecpt cc exension](http://asset.blog.hibrainapps.net/saltfactory/images/4b6b5c7f-4b91-44a4-a0c2-ec1b85f33d19)
...
![turn on](http://asset.blog.hibrainapps.net/saltfactory/images/bea67ba1-1af0-4ef2-9774-b056c9eb9ad4)
...
![데스크탑 목록](http://asset.blog.hibrainapps.net/saltfactory/images/8c35ae67-3e5d-45e5-a64f-e5502f88f2dd)
...
![테스크탑 커넥션](http://asset.blog.hibrainapps.net/saltfactory/images/c8bfe0c2-55ce-4afd-b8e4-0db828a499a0)

Chrome extension은 다음과 같이 모바일 디바이스가 연결된 것을 확인할 수 있다.

![exteions의 모바일 연결정보](http://asset.blog.hibrainapps.net/saltfactory/images/f7a569aa-c878-4cfc-aed0-5d979876ad8b)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/8cb10b5e-f1a3-4973-8299-33bfebad9ff4)

모바일 디바이스 화면을 살펴보자. 다음과 같이 타이틀바가 사라지고 full screen 화면을 볼 수 있다.

![full screen on devices](http://asset.blog.hibrainapps.net/saltfactory/images/fc630646-0c65-45d6-bfc3-6e0ca11aaf05)
...
![weinre](http://asset.blog.hibrainapps.net/saltfactory/images/833eec47-81be-4cdc-98af-9e0de347cba7)
...
![](http://asset.blog.hibrainapps.net/saltfactory/images/fad52a47-451d-4676-b987-bfbddca80875)

모바일 디바이스를 살펴보자. 이것은 모바일에 나타난 웹에 바로 적용이 된다. **모바일 웹**에만 적용이 되는 것이다. 데스크탑에 열린 웹은 적용되지 않는다.

![](http://asset.blog.hibrainapps.net/saltfactory/images/a87199e1-b05f-42ad-9204-721fadc457ed)
